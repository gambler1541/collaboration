...
$(function() {
	...
	$('#deadline').change(function(){
	      ...
	      if(create == ''){
	         swal('Please set a start date!');
	         $('#deadline').val('');
	      }else{
	         var startArray = create.split('-');
	         ...
	         if(start_date.getTime() > end_date.getTime()){
	            $('#create').val('');
	            $('#deadline').val('');
	            swal('Deadline should be future!');
	         }
	      }
	   })
		...
		<div id="cardWriteView">
   			<div class="cardBack2">
      			...
      			<div id="cardWrite">
         			...
         			<div class="inline">
         				Create At&emsp;
         				<input class="date" type="date" name="cCreate" id="create"/>&emsp; ~
         				
         				&emsp;&emsp;Deadline&emsp;
         				
         				<input class="date" type="date" name="cDeadline" id="deadline"/>
         			</div>
         			
         			<br><br>
         			
         			<div class="inline">
            			<input type="text" placeholder="Enter the title" id="title" name="cTitle" class="titleWrite" size="56" maxlength="15" style="height:30px;"/>
         			</div>
